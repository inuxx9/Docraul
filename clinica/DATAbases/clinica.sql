...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-10-2025 a las 16:43:18
...
(5, 1, '2025-10-28', '15:30:00', 'dolor de muela', 'Pendiente', NULL, '2025-10-29 14:05:34');
...
INSERT INTO `dentistas` (`dentista_id`, `nombre`, `especialidad`) VALUES
(1, 'L.Joaquin', 'dentista'),
(2, 'B.L.Ruiz Diaz', 'Odontologa'),
(3, 'L.Joaquin', 'cirujano maxilofacial');
...
--
ALTER TABLE `citas`
  MODIFY `cita_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
